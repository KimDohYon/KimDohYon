...
// Additional weights (various convolution ops)
...
void initialize_weights() {
    ...
    // Load Cell 0 layer weights
    std::cout << "Loading Cell 0 layer weights..." << std::endl;
    ...
    // Load Cell 1 layer weights
    std::cout << "Loading Cell 1 layer weights..." << std::endl;
    ...
    // Load Cell 1 BatchNorm parameters
    std::cout << "Loading BatchNorm parameters for Cell 1..." << std::endl;
    ...
    // Load classifier layer weights
    std::cout << "Loading classifier weights..." << std::endl;
    load_weights_from_file("classifier.weight.txt", classifier_weight);
    load_weights_from_file("classifier.bias.txt", classifier_bias);

    // Load additional convolutional op weights
    std::cout << "Loading additional operator weights..." << std::endl;
